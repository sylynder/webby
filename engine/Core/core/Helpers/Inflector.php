...
/**
 * Borrowed from the CodeIgniter4 Inflector Helper Functions
 * To use it as static class methods
 */
...
class Inflector 
{
     ...
     * @param string $string Input string
     */
    public static function counted(int $count, string $string): string
    {
        $result = "{$count} ";
    ...
    /**
     * Checks if the given word has a plural version.
     * Used by CodeIgniter 3
     * 
     * @param	string	$word	Word to check
     * @return	bool
     */
    public static function isWordCountable($word)
    {
        return !in_array(
            strtolower($word),
            [
     ...
     */
    public static function ordinal(int $integer): string
    {
        $suffixes = [
            'th',
            'st',
     ...
     */
    public static function ordinalize(int $integer): string
    {
