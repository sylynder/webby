...
<body>
    <div class="w-full h-screen bg-primary">
        <div class="construction-message">
            ...
            <div class="hero container max-w-screen-lg mx-auto mt-10 mb-10 flex justify-center">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100.001px" height="70px" viewBox="0 0 100 68">
                    <g id="large">
                        ...
                        c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z" fill="none" stroke="#6d00cc" />
                        ...
                        C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#6d00cc" />
            ...
            <div class="mb-10">
                <h2><code>App Is Currently Under Maintenance</code></h3>
            </div>
            <p>&copy; <?= config_item('app_name') ?> | <?=date('F, Y')?></p>
        </div>
    </div>
</body>
